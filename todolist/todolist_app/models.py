...
class Task(models.Model):
    ...
    name = models.CharField(max_length=150, default='no name', verbose_name='what to do?')
    description = models.TextField(null=True, blank=True, verbose_name='get into details if needed ...')
